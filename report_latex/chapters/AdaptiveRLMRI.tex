...
long blocks and under-covers the episode's realised $T_1$ values. The RL
...
the same seed. (A slightly different in-pipeline seven-point sanity grid
scores 5.86\%; the ten-point baseline-harness schedule is the authoritative
comparator, and the conclusion is unchanged under either.) The 560 s
