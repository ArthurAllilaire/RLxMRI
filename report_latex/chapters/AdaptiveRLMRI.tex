...
This was an evidence-based simplification. In Run A the learned flip angles
collapsed to $90^\circ$, and the Cramer--Rao fixed-schedule baseline also chose
$90^\circ$ because it reduced the CRLB. The flip-angle degree of freedom was
therefore redundant for the T1 experiments reported here, so later runs used the
capacity on timing decisions rather than re-learning the same boundary solution.
...
baseline also selected $90^\circ$ flip angles. This is why $\alpha$ was fixed in
the later Run B family: both the learned policy and the CRLB baseline indicated
that the useful optimisation pressure was in TI/TR timing, not flip-angle
selection.
