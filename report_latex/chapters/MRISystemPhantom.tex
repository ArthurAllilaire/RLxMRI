...
% TODO: Insert a screenshot/photo of the new Plotly HTML phantom viewer here,
% ideally showing the vertical slice or fidelity-phantom water grid comparison.

\begin{itemize}
\tightlist
\item
  \texttt{plot\_phantom.jl}: renders the T1/T2/PD maps of the full
  phantom, per-plate axial slices, the fiducial grid, a vertical slice
  through all three contrast plates, and an augmented rotated/translated
  phantom. The outputs are interactive Plotly HTML files.
\item
  \texttt{plot\_fidelity\_phantoms.jl}: visualises the phantom geometry 
  (water-coarsening and caching) behind the multi-fidelity RL curriculum.
  The outputs are interactive Plotly HTML files.
\item
