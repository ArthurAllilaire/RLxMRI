...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.52\linewidth]{imgs/mri_system_phantom/Premium-System-Phantom.png}
\caption{\textbf{The QalibreMD NIST/ISMRM System Standard Model 130 hardware
phantom.} Image reproduced from
...
\node[plusbox, right=of desc, xshift=42mm] (merge) {\texttt{+}};
