...
\PassOptionsToPackage{nohints}{minitoc}
...
\AtBeginBibliography{\sloppy\emergencystretch=3em\relax}
% ... TO HERE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{Reinforcement Learning for Adaptive Quantitative MRI in a Validated Digital Phantom}
\subtitle{} % use \subtitle{} to remove the subtitle
\author{A. Allilaire}
\cid{02372975}
\supervisor{Dr Andreas Wetscherek \\[1mm] Prof. Wayne Luk} %UK: Dr no dot, prof has dot
\submityear{2026}
...
\setboolean{final_thesis}{false} % true for final Thesis / false for interim report
\secondmarker{Second Marker\\[2mm]{\large \textsc Prof. Ben Glocker}} %If you do not know who your second marker is, use 
% \secondmarker{}
...
\definecolor{V2accent}{RGB}{200,80,0}     % orange accent for the V2 guardrail (controller diagram)
...
% Tighten chapter-heading whitespace to push body text up (overrides class).
\titleformat{\chapter}[display]
  {\normalfont\fontsize{55}{57}\raggedleft\bfseries\color{ImperialBlue}}{\ \thechapter}{-30pt}{\Huge\raggedleft\color{ImperialBlue}}
\titlespacing*{\chapter}{0pt}{0pt}{8pt}


\hypersetup{
  pdftitle={Reinforcement Learning for Adaptive Quantitative MRI in a Validated Digital Phantom},
  pdfauthor={Arthur Allilaire}}
...
\input{Chapter1.tex}
\input{Chapter2.tex}
\input{MRISystemPhantom.tex}
\input{ValidatingKomaMRI.tex}
\input{AdaptiveRLMRI.tex}
%\input{LastChapter.tex}

% You can change the title of the conclusions by changing the text between { }
\conclusions{Summary} % Do not remove - required
