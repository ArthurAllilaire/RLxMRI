...
- Pearson correlation between TI and running T1 estimate inside an episode: r = −0.26 (significant at N=200).
- KS test on TI distributions, all-long-T1 subset vs all-short-T1 subset: p < 1e-6.
...
| File | What it shows | Where it lives in the narrative |
|---|---|---|
| `runs/e2/e2_tractability_V12/sse_landscape/sse_landscape.png` | 12 worst-failing-sphere SSE-vs-T1 landscapes; truth in green is far from global SSE-min | §2.6 — the key result of the week |
| `report_plots/E2_tractability_V9/v9_vs_fixed_anchors.png` | V9 / V12 vs CR-opt / log-grid headline MAPE | §2.4 — pre-oracle picture |
| `report_plots/E2_tractability_V9/v9_diagnostic_summary.png` | Episode-by-episode TI choices, T1 estimates, scan time | §2.4 — V9 behaviour |
| `runs/e2/e2_tractability_V12/diagnostics/ti_vs_t1est.png` | TI vs running T1_est scatter, r = −0.26 | §2.4 — adaptivity claim that survives §2.5 |
| `runs/e2/e2_tractability_V12/diagnostics/ti_histogram_by_subset_bucket.png` | TI distribution for all-long vs all-short subsets, KS-significant | §2.4 — second adaptivity claim |
| `report_plots/E2.1/per_sphere_mape.png` | per-sphere T1 MAPE for V5 (14-sphere setting) | §2.2 — early E2.4 result |
| `runs/e2/e2_3_A_C_delta/refit/sigma_calibration.png` | σ vs |err| scatter before and after F1+ / σ-fixes A+B | §2.1 — the one cleanly positive result |
